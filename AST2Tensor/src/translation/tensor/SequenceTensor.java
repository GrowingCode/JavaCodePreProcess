...
//	ArrayList<String> content = new ArrayList<String>();
	...
	public void AppendOneToken(IDManager im, TypeContentID t_c, int isExisted, int lastIndex, int t_c_is_real) {
...
//	}
	...
	public String toString() {
		...
		String result = StringUtils.join(inner_id_type_content_id.toArray(), " ") + "#" + StringUtils.join(type_content_id.toArray(), " ") + " " + StringUtils.join(isExistedList.toArray(), " ") + " " + StringUtils.join(lastIndexList.toArray(), " ") + " " + StringUtils.join(is_real.toArray(), " ") + " " + StringUtils.join(inner_type_content_id.toArray(), " ");// + " " + StringUtils.join(decode_type_id.toArray(), " ")
		return result.trim();
	}
	...
	public String toDebugString() {
		...
		String result = StringUtils.join(type_content_id.toArray(), " ") + line_seperator + StringUtils.join(isExistedList.toArray(), " ") + line_seperator + StringUtils.join(lastIndexList.toArray(), " ") + line_seperator + StringUtils.join(is_real.toArray(), " ");// + line_seperator + StringUtils.join(decode_type_id.toArray(), " ")
		return result;
	}
	...
	public String toOracleString() {
		...
		String result = StringUtils.join(type_content_str.toArray(), " ") + line_seperator + StringUtils.join(isExistedList.toArray(), " ") + line_seperator + StringUtils.join(lastIndexList.toArray(), " ") + line_seperator + StringUtils.join(is_real.toArray(), " ");// + line_seperator + StringUtils.join(decode_type_id.toArray(), " ")
		return result;
	}
