...
public class JavaImportOperation {
	...
	// Set<String>
	public static void ImportFileSystem(IJavaProject javaProject, Map<String, TreeMap<String, String>> dir_files_map)
		...
		while (diritr.hasNext()) {
			...
			System.out.println("==== Import " + index + "/" + dir_files_map.size() + "#" + dir + ": " + files.size()
					+ " files ====");
