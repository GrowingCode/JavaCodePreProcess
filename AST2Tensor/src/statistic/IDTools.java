...
//	TokenRecorder str, GrammarRecorder gr, RoleAssigner role_assigner, 
	public IDTools(BPEMergeRecorder bpe_mr, TokenRecorder tr, TokenRecorder sr, APIRecorder ar, ChildrenNumCounter cnc) {
		this.bpe_mr = bpe_mr;
