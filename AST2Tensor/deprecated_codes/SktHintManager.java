...
//		this.im = im;
		...
		one_hint_hit_num = RegistUtil.Regist(skt_one_parent_hint_id_map, recorder.one_r.hit_train.GetOriginMap(),
				MetaOfApp.MinimumEachSkeletonNotUnkAppearTime, recorder.one_r.not_hit_train.GetOriginMap(),
				MetaOfApp.NumberOfSkeletonUnk, MetaOfApp.MinimumNumberOfSkeletonVocabulary, "one_hit");
		pe_hint_hit_num = RegistUtil.Regist(skt_pe_parent_hint_id_map, recorder.pe_r.hit_train.GetOriginMap(),
				MetaOfApp.MinimumEachSkeletonNotUnkAppearTime, recorder.pe_r.not_hit_train.GetOriginMap(),
				MetaOfApp.NumberOfSkeletonUnk, MetaOfApp.MinimumNumberOfSkeletonVocabulary, "pe_hit");
		e_hint_hit_num = RegistUtil.Regist(skt_e_parent_hint_id_map, recorder.e_r.hit_train.GetOriginMap(),
				MetaOfApp.MinimumEachSkeletonNotUnkAppearTime, recorder.e_r.not_hit_train.GetOriginMap(),
				MetaOfApp.NumberOfSkeletonUnk, MetaOfApp.MinimumNumberOfSkeletonVocabulary, "e_hit");
	}
...
//	}
	...
	private void RegistHintIDTokenID(TreeMap<Integer, TreeSet<Integer>> skt_parent_hint_id_token_id_map,
			int parent_hint_id, int otid) {
